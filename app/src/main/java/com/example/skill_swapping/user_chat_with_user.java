...
public class user_chat_with_user extends Activity
{
    EditText ed1;
    ImageView b1;
    String chat;
...
//    String soapaction="";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_user_chat_with_user);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                if (chat.equalsIgnoreCase("")) {
                    ...
                    String url = sh.getString("url", "") + "/user_sended_chat";
...
//                void getChats () {
                ...
                String url = sh.getString("url", "") + "/user_view_sended_chat";
...
//                                    val[i] = "skills : "+skill[i]+"\n\nusername    : "+username[i]+"\n\namount :"+amount[i]+"\n\ndetails :"+details[i]+"\n\ndate:"+date[i]+"\n\nstatus:"+status[i] ;
                                        ...
                                        l1.setAdapter(new Customchat_d(user_chat_with_user.this, message, s_id, date));//custom_view_service.xml and li is the listview object
