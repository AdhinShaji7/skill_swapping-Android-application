...
public class custom_image1 extends BaseAdapter {
    private Context context;

    String [] issue,photo,preq_id;

    public custom_image1(Context con, String[]highlights,String[]photo,String[] pid)
...
//        edistrict.setTextColor(Color.BLACK);
        ...
        labourname1.setText("Name :"+issue[i]);
//        labourname2.setText("\nGender : "+gender[i]);
//        labourname3.setText("\n\nPlace : "+place[i]);
//        fphone.setText("\n\n\nPhone : "+phone[i]);
//        femail.setText("\n\n\n\nEmail : "+email[i]);
