...
public class user_view_skill extends AppCompatActivity {
    ListView ll;
    String[] myskill_id,cname,sname,val;
    public  static String mysk1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_view_skill);
        ll=(ListView) findViewById(R.id.listview);


        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String url=sh.getString("url","")+"/user_view_skill_badgeorachive";
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("myid", user_view_skill.mysk1);//passing to python
        ...
        ll.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                mysk1=myskill_id[i];
                final CharSequence[] items1 = {"Delete"};

                AlertDialog.Builder builder = new AlertDialog.Builder(user_view_skill.this);
                builder.setItems(items1, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int item) {
                        if (items1[item].equals("Delete")) {

                            String url = "http://" + sh.getString("ip", "") + "/api/deleteskill";
                            VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, url,
                                    new Response.Listener<NetworkResponse>() {
                                        @Override
                                        public void onResponse(NetworkResponse response) {
