...
public class user_add_issue extends AppCompatActivity {
    ImageView img1;
    EditText e1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_add_issue);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            private void uploadBitmap(String issue) {
                sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                sh.getString("ip", "");
                String url=sh.getString("url","")+"/user_add_issue";
...
//                        Toast.makeText(getApplicationContext(), error.getMessage(), Toast.LENGTH_SHORT).show();
                        ...
                        })
                {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError  {
                        ...
                        params.put("issue", issue);//passing to python
...
//                params.put("", lname);//passing to python
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_CODE && resultCode == RESULT_OK && null != data) {
            ...
            //String path = null;
            try {
                path = FileUtils.getPath(user_add_issue.this, uri);
    ...
    private void selectImageOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(user_add_issue.this);
